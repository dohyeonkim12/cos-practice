...
int twos_complemt_addition(char *bv1, char *bv2);
int ones_complemt_addition(char *bv1, char *bv2);
...
int b2o(char *bv){
    ...
    term = -i * bv[MSB_INDEX] * (exp(2, MSB_INDEX) -1);
    for(i=LSB_INDEX; i<MSB_INDEX; i++)
        ret += bv[i] * exp(2, i);
    ret += term;
    return ret;
